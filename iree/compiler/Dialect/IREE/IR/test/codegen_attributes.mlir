...
"some_op"() {
// CHECK:  #iree.codegen.action.tile<along_dimensions = [0, 1, 2, 3], with_tile_size = [8, 16, 32, 4]>
  action = #iree.codegen.action.tile<along_dimensions = [0, 1, 2, 3], with_tile_size = [8, 16, 32, 4]>
} : () -> ()
    ...
    [
      ...
      #iree.codegen.op.policy<"linalg.matmul", FirstMatch, [
        #iree.codegen.op.choice<
          ...
          [#iree.codegen.action.tile<along_dimensions = [0, 1], with_tile_size = [16, 64]>]
        >
      ]>
    ]
  >
