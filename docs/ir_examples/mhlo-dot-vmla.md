...
title: "mhlo-dot IR conversion example for vmla backend"
parent: IR Conversion Examples
---

# mhlo-dot IR conversion example for vmla backend
{: .no_toc }
...
func @dot_ex_dispatch_0() {
  ...
  %3 = "shapex.to_extent_tensor"(%2) : (!shapex.ranked_shape<[?,?,?]>) -> tensor<3xindex>
  %4 = "mhlo.dynamic_reshape"(%0, %3) : (tensor<32x1024xf32>, tensor<3xindex>) -> tensor<?x?x?xf32>
  %5 = "shapex.from_extent_tensor"(%3) : (tensor<3xindex>) -> !shapex.ranked_shape<[?,?,?]>
  %6 = shapex.tie_shape %4, %5 : tensor<?x?x?xf32>, !shapex.ranked_shape<[?,?,?]>
  %7 = "mhlo.transpose"(%1) {permutation = dense<[1, 0]> : tensor<2xi64>} : (tensor<1024x64xf32>) -> tensor<?x?xf32>
  %8 = shapex.make_ranked_shape %c64, %c1024 : (index, index) -> !shapex.ranked_shape<[?,?]>
  %9 = shapex.tie_shape %7, %8 : tensor<?x?xf32>, !shapex.ranked_shape<[?,?]>
  %10 = shapex.make_ranked_shape %c1, %c64, %c1024 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
  %11 = "shapex.to_extent_tensor"(%10) : (!shapex.ranked_shape<[?,?,?]>) -> tensor<3xindex>
  %12 = "mhlo.dynamic_reshape"(%9, %11) : (tensor<?x?xf32>, tensor<3xindex>) -> tensor<?x?x?xf32>
  %13 = "shapex.from_extent_tensor"(%11) : (tensor<3xindex>) -> !shapex.ranked_shape<[?,?,?]>
  %14 = shapex.tie_shape %12, %13 : tensor<?x?x?xf32>, !shapex.ranked_shape<[?,?,?]>
  %15 = vmla.batch.matmul.pseudo %6, %14 : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
  %16 = shapex.ranked_dim %5[0] : !shapex.ranked_shape<[?,?,?]> -> index
  %17 = shapex.ranked_dim %13[1] : !shapex.ranked_shape<[?,?,?]> -> index
  %18 = shapex.ranked_dim %5[1] : !shapex.ranked_shape<[?,?,?]> -> index
  %19 = shapex.make_ranked_shape %16, %17, %18 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
  %20 = shapex.tie_shape %15, %19 : tensor<?x?x?xf32>, !shapex.ranked_shape<[?,?,?]>
  %21 = "mhlo.transpose"(%20) {permutation = dense<[0, 2, 1]> : tensor<3xi64>} : (tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
  %22 = shapex.make_ranked_shape %16, %18, %17 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
  %23 = shapex.tie_shape %21, %22 : tensor<?x?x?xf32>, !shapex.ranked_shape<[?,?,?]>
  %24 = "mhlo.reshape"(%23) : (tensor<?x?x?xf32>) -> tensor<32x64xf32>
  hal.interface.store.tensor %24, @legacy_io::@ret0, offset = %c0 : tensor<32x64xf32>
  return
}
...
func @dot_ex_dispatch_0() {
  ...
  %c32 = constant 32 : index
  %c1 = constant 1 : index
  %1 = hal.interface.load.tensor @legacy_io::@arg0, offset = %c0 : tensor<32x1024xf32>
  %2 = hal.interface.load.tensor @legacy_io::@arg1, offset = %c0 : tensor<1024x64xf32>
  %3 = shapex.make_ranked_shape %c1, %c32, %c1024 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
  %4 = "shapex.to_extent_tensor"(%3) : (!shapex.ranked_shape<[?,?,?]>) -> tensor<3xindex>
  %5 = "mhlo.dynamic_reshape"(%1, %4) : (tensor<32x1024xf32>, tensor<3xindex>) -> tensor<?x?x?xf32>
  %6 = "shapex.from_extent_tensor"(%4) : (tensor<3xindex>) -> !shapex.ranked_shape<[?,?,?]>
  %7 = shapex.ranked_dim %6[1] : !shapex.ranked_shape<[?,?,?]> -> index
  %8 = shapex.ranked_dim %6[0] : !shapex.ranked_shape<[?,?,?]> -> index
  %9 = shapex.tie_shape %5, %6 : tensor<?x?x?xf32>, !shapex.ranked_shape<[?,?,?]>
  %10 = "mhlo.transpose"(%2) {permutation = dense<[1, 0]> : tensor<2xi64>} : (tensor<1024x64xf32>) -> tensor<?x?xf32>
  %11 = shapex.tie_shape %10, %0 : tensor<?x?xf32>, !shapex.ranked_shape<[?,?]>
  %12 = shapex.make_ranked_shape %c1, %c64, %c1024 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
  %13 = "shapex.to_extent_tensor"(%12) : (!shapex.ranked_shape<[?,?,?]>) -> tensor<3xindex>
  %14 = "mhlo.dynamic_reshape"(%11, %13) : (tensor<?x?xf32>, tensor<3xindex>) -> tensor<?x?x?xf32>
  %15 = "shapex.from_extent_tensor"(%13) : (tensor<3xindex>) -> !shapex.ranked_shape<[?,?,?]>
  %16 = shapex.ranked_dim %15[1] : !shapex.ranked_shape<[?,?,?]> -> index
  %17 = shapex.make_ranked_shape %8, %7, %16 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
  %18 = shapex.make_ranked_shape %8, %16, %7 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
  %19 = shapex.tie_shape %14, %15 : tensor<?x?x?xf32>, !shapex.ranked_shape<[?,?,?]>
  %20 = vmla.batch.matmul.pseudo %9, %19 : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
  %21 = shapex.tie_shape %20, %18 : tensor<?x?x?xf32>, !shapex.ranked_shape<[?,?,?]>
  %22 = "mhlo.transpose"(%21) {permutation = dense<[0, 2, 1]> : tensor<3xi64>} : (tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
  %23 = shapex.tie_shape %22, %17 : tensor<?x?x?xf32>, !shapex.ranked_shape<[?,?,?]>
  %24 = "mhlo.reshape"(%23) : (tensor<?x?x?xf32>) -> tensor<32x64xf32>
  hal.interface.store.tensor %24, @legacy_io::@ret0, offset = %c0 : tensor<32x64xf32>
  return
}
...
module {
  func @dot_ex_dispatch_0(%arg0: !vmla.interface, %arg1: index, %arg2: index, %arg3: index) {
    ...
    %c32 = constant 32 : index
    %c1 = constant 1 : index
    %1 = vmla.interface.binding %arg0 {binding = 0 : i32, set = 0 : i32} : !vmla.buffer
    %c4 = constant 4 : index
    %rs32_1024 = shapex.const_ranked_shape : !shapex.ranked_shape<[32,1024]>
    %c32_0 = constant 32 : index
    %c1024_1 = constant 1024 : index
    %2 = muli %c4, %c32_0 : index
    %3 = muli %2, %c1024_1 : index
    %4 = vmla.buffer.view %1[%c0], byte_length = %3 : !vmla.buffer
    %5 = vmla.interface.binding %arg0 {binding = 1 : i32, set = 0 : i32} : !vmla.buffer
    ...
    %6 = muli %c4_2, %c1024_3 : index
    %7 = muli %6, %c64_4 : index
    %8 = vmla.buffer.view %5[%c0], byte_length = %7 : !vmla.buffer
    %9 = shapex.make_ranked_shape %c1, %c32, %c1024 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
    %10 = "shapex.to_extent_tensor"(%9) : (!shapex.ranked_shape<[?,?,?]>) -> tensor<3xindex>
    %11 = shapex.tie_shape %4, %9 : !vmla.buffer, !shapex.ranked_shape<[?,?,?]>
    %rs1024_64_5 = shapex.const_ranked_shape : !shapex.ranked_shape<[1024,64]>
    %c4_6 = constant 4 : index
    %12 = muli %c4_6, %c64 : index
    %13 = muli %12, %c1024 : index
    %14 = vmla.buffer.alloc byte_length = %13 : !vmla.buffer
    vmla.transpose %8(%rs1024_64_5 : !shapex.ranked_shape<[1024,64]>), out %14(%0 : !shapex.ranked_shape<[?,?]>) {permutation = dense<[1, 0]> : tensor<2xi32>} : f32
    %15 = shapex.tie_shape %14, %0 : !vmla.buffer, !shapex.ranked_shape<[?,?]>
    %16 = shapex.make_ranked_shape %c1, %c64, %c1024 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
    %17 = "shapex.to_extent_tensor"(%16) : (!shapex.ranked_shape<[?,?,?]>) -> tensor<3xindex>
    %18 = shapex.make_ranked_shape %c1, %c32, %c64 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
    %19 = shapex.make_ranked_shape %c1, %c64, %c32 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
    %20 = shapex.tie_shape %15, %16 : !vmla.buffer, !shapex.ranked_shape<[?,?,?]>
    ...
    vmla.batch.matmul %11(%9 : !shapex.ranked_shape<[?,?,?]>) : tensor<?x?x?xf32>, %20(%16 : !shapex.ranked_shape<[?,?,?]>) : tensor<?x?x?xf32>, out %24(%19 : !shapex.ranked_shape<[?,?,?]>) : tensor<?x?x?xf32>
    %25 = shapex.tie_shape %24, %19 : !vmla.buffer, !shapex.ranked_shape<[?,?,?]>
    ...
    vmla.transpose %25(%19 : !shapex.ranked_shape<[?,?,?]>), out %29(%18 : !shapex.ranked_shape<[?,?,?]>) {permutation = dense<[0, 2, 1]> : tensor<3xi32>} : f32
    %30 = shapex.tie_shape %29, %18 : !vmla.buffer, !shapex.ranked_shape<[?,?,?]>
...
func @dot_ex_dispatch_0(%arg0: !vmla.interface, %arg1: index, %arg2: index, %arg3: index) {
  ...
  %c4 = constant 4 : index
  %2 = muli %c4, %c32 : index
  %3 = muli %2, %c1024 : index
  %4 = vmla.buffer.view %1[%c0], byte_length = %3 : !vmla.buffer
  %5 = vmla.interface.binding %arg0 {binding = 1 : i32, set = 0 : i32} : !vmla.buffer
  %6 = muli %c4, %c1024 : index
  %7 = muli %6, %c64 : index
  %8 = vmla.buffer.view %5[%c0], byte_length = %7 : !vmla.buffer
  %9 = shapex.make_ranked_shape %c1, %c32, %c1024 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
  %10 = shapex.tie_shape %4, %9 : !vmla.buffer, !shapex.ranked_shape<[?,?,?]>
  %rs1024_64 = shapex.const_ranked_shape : !shapex.ranked_shape<[1024,64]>
  %11 = muli %c4, %c64 : index
  %12 = muli %11, %c1024 : index
  %13 = vmla.buffer.alloc byte_length = %12 : !vmla.buffer
  vmla.transpose %8(%rs1024_64 : !shapex.ranked_shape<[1024,64]>), out %13(%0 : !shapex.ranked_shape<[?,?]>) {permutation = dense<[1, 0]> : tensor<2xi32>} : f32
  %14 = shapex.tie_shape %13, %0 : !vmla.buffer, !shapex.ranked_shape<[?,?]>
  %15 = shapex.make_ranked_shape %c1, %c64, %c1024 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
  %16 = shapex.make_ranked_shape %c1, %c32, %c64 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
  %17 = shapex.make_ranked_shape %c1, %c64, %c32 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
  %18 = shapex.tie_shape %14, %15 : !vmla.buffer, !shapex.ranked_shape<[?,?,?]>
  %19 = muli %c4, %c1 : index
  %20 = muli %19, %c64 : index
  %21 = muli %20, %c32 : index
  %22 = vmla.buffer.alloc byte_length = %21 : !vmla.buffer
  vmla.batch.matmul %10(%9 : !shapex.ranked_shape<[?,?,?]>) : tensor<?x?x?xf32>, %18(%15 : !shapex.ranked_shape<[?,?,?]>) : tensor<?x?x?xf32>, out %22(%17 : !shapex.ranked_shape<[?,?,?]>) : tensor<?x?x?xf32>
  %23 = shapex.tie_shape %22, %17 : !vmla.buffer, !shapex.ranked_shape<[?,?,?]>
  %24 = muli %19, %c32 : index
  %25 = muli %24, %c64 : index
  %26 = vmla.buffer.alloc byte_length = %25 : !vmla.buffer
  vmla.transpose %23(%17 : !shapex.ranked_shape<[?,?,?]>), out %26(%16 : !shapex.ranked_shape<[?,?,?]>) {permutation = dense<[0, 2, 1]> : tensor<3xi32>} : f32
  %27 = shapex.tie_shape %26, %16 : !vmla.buffer, !shapex.ranked_shape<[?,?,?]>
...
func @dot_ex_dispatch_0(%arg0: !vmla.interface, %arg1: index, %arg2: index, %arg3: index) {
  ...
  %0 = shapex.make_ranked_shape %c64, %c1024 : (index, index) -> !shapex.ranked_shape<[?,?]>
  %1 = vmla.interface.binding %arg0 {binding = 0 : i32, set = 0 : i32} : !vmla.buffer
  %2 = vmla.buffer.view %1[%c0], byte_length = %c131072 : !vmla.buffer
  %3 = vmla.interface.binding %arg0 {binding = 1 : i32, set = 0 : i32} : !vmla.buffer
  %4 = vmla.buffer.view %3[%c0], byte_length = %c262144 : !vmla.buffer
  %5 = shapex.make_ranked_shape %c1, %c32, %c1024 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
  %6 = shapex.tie_shape %2, %5 : !vmla.buffer, !shapex.ranked_shape<[?,?,?]>
  %7 = vmla.buffer.alloc byte_length = %c262144 : !vmla.buffer
  vmla.transpose %4(%rs1024_64 : !shapex.ranked_shape<[1024,64]>), out %7(%0 : !shapex.ranked_shape<[?,?]>) {permutation = dense<[1, 0]> : tensor<2xi32>} : f32
  %8 = shapex.tie_shape %7, %0 : !vmla.buffer, !shapex.ranked_shape<[?,?]>
  %9 = shapex.make_ranked_shape %c1, %c64, %c1024 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
  %10 = shapex.make_ranked_shape %c1, %c32, %c64 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
  %11 = shapex.make_ranked_shape %c1, %c64, %c32 : (index, index, index) -> !shapex.ranked_shape<[?,?,?]>
  %12 = shapex.tie_shape %8, %9 : !vmla.buffer, !shapex.ranked_shape<[?,?,?]>
  %13 = vmla.buffer.alloc byte_length = %c8192 : !vmla.buffer
  vmla.batch.matmul %6(%5 : !shapex.ranked_shape<[?,?,?]>) : tensor<?x?x?xf32>, %12(%9 : !shapex.ranked_shape<[?,?,?]>) : tensor<?x?x?xf32>, out %13(%11 : !shapex.ranked_shape<[?,?,?]>) : tensor<?x?x?xf32>
  %14 = shapex.tie_shape %13, %11 : !vmla.buffer, !shapex.ranked_shape<[?,?,?]>
  %15 = vmla.buffer.alloc byte_length = %c8192 : !vmla.buffer
  vmla.transpose %14(%11 : !shapex.ranked_shape<[?,?,?]>), out %15(%10 : !shapex.ranked_shape<[?,?,?]>) {permutation = dense<[0, 2, 1]> : tensor<3xi32>} : f32
  %16 = shapex.tie_shape %15, %10 : !vmla.buffer, !shapex.ranked_shape<[?,?,?]>
...
module {
  ...
  func @dot(%arg0: !hal.buffer {iree.reflection = {}}, %arg1: !hal.buffer {iree.reflection = {}}) attributes {iree.module.export, iree.reflection = {f = "I23!B9!d32d1024B9!d1024d64R1!", fv = "1"}} {
    ...
    #hal.device.match.id<"vmla">(%arg2 = %c2048 : index, %arg3 = %cmd : !hal.command_buffer, %arg4 = %exe : !hal.executable) {
      %c1 = constant 1 : index
...
module {
  ...
  func @dot(%arg0: !hal.buffer {iree.reflection = {}}, %arg1: !hal.buffer {iree.reflection = {}}) attributes {iree.module.export = "dot$raw"} {
    ...
    hal.device.switch(%dev : !hal.device)
    #hal.device.match.id<"vmla">(%arg2 = %c2048 : index, %arg3 = %cmd : !hal.command_buffer, %arg4 = %0 : !hal.executable) {
      %c1 = constant 1 : index
      hal.command_buffer.dispatch %arg3, %arg4, entry_point = 0, workgroup_xyz = [%c1, %c1, %c1]
      hal.return
    }
...
hal.executable @dot_ex_dispatch_0 attributes {sym_visibility = "private"} {
  ...
  hal.executable.entry_point @dot_ex_dispatch_0 attributes {interface = @legacy_io, ordinal = 0 : i32, signature = (tensor<32x1024xf32>, tensor<1024x64xf32>) -> tensor<32x64xf32>}
  hal.executable.binary attributes {data = dense<""> : vector<1160xi8>, format = 1447906369 : i32} {
  }
}
...
module {
  vm.module @module {
    ...
    vm.rodata @_dot_ex_dispatch_0_binary_vmla dense<""> : vector<1160xi8>
