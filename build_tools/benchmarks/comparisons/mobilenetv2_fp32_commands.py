...
class MobileNetV2FP32CommandFactory(BenchmarkCommandFactory):
  ...
  def _generate_cpu(self):
    ...
    tflite_mobilebert = TfliteMobileNetV2FP32(self._tflite_benchmark_binary_path,
                                             self._model_name,
    ...
    iree_mobilebert = IreeMobileNetV2FP32(self._iree_benchmark_binary_path,
                                         self._model_name,
    ...
    iree_mmt4d_mobilebert = IreeMobileNetV2FP32(self._iree_benchmark_binary_path,
                                               model_mmt4d_name,
  ...
  def _generate_gpu(self, driver: str):
    ...
    tflite_mobilebert_fp16 = TfliteMobileNetV2FP32(
