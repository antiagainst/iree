...
class TflitePoseNetFP32(TFLiteBenchmarkCommand):
...
class IreePoseNetFP32(IreeBenchmarkCommand):
  ...
  def __init__(self, benchmark_binary: str, model_name: str, model_path: str,
    ...
    self.args.append("--function_input=1x353x257x3xf32")


class PoseNetFP32CommandFactory(BenchmarkCommandFactory):
  """ Generates `BenchmarkCommand` objects specific to running MobileBert."""

  def __init__(self, base_dir: str):
    self._model_name = "posenet"
  ...
  def _generate_cpu(self):
    ...
    tflite_mobilebert = TflitePoseNetFP32(self._tflite_benchmark_binary_path,
                                             self._model_name,
    ...
    iree_mobilebert = IreePoseNetFP32(self._iree_benchmark_binary_path,
                                         self._model_name,
    ...
    iree_mmt4d_mobilebert = IreePoseNetFP32(self._iree_benchmark_binary_path,
                                               model_mmt4d_name,
  ...
  def _generate_gpu(self, driver: str):
    ...
    tflite_mobilebert_fp16 = TflitePoseNetFP32(
