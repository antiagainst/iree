...
static iree_status_t iree_hal_metal_command_buffer_execution_barrier(
  ...
  if (flags != IREE_HAL_EXECUTION_BARRIER_FLAG_NONE) {
    return iree_make_status(IREE_STATUS_UNIMPLEMENTED, "unimplemented barrier flag");
  }
...
static iree_status_t iree_hal_metal_command_buffer_signal_event(
  ...
  return iree_make_status(IREE_STATUS_UNIMPLEMENTED, "unimplemented event signal");
}

static iree_status_t iree_hal_metal_command_buffer_reset_event(
    iree_hal_command_buffer_t* base_command_buffer, iree_hal_event_t* event,
    iree_hal_execution_stage_t source_stage_mask) {
  return iree_make_status(IREE_STATUS_UNIMPLEMENTED, "unimplemented event reset");
}
...
static iree_status_t iree_hal_metal_command_buffer_wait_events(
  ...
  return iree_make_status(IREE_STATUS_UNIMPLEMENTED, "unimplemented event wait");
}
