// RUN: iree-opt --split-input-file --verify-diagnostics --pass-pipeline="builtin.module(func.func(iree-flow-form-dispatch-regions{aggressive-fusion=true}, iree-flow-clone-producers-into-dispatch-regions, iree-flow-convert-standalone-extract-insert-slices, iree-flow-form-dispatch-workgroups), cse, canonicalize, cse)" %s | FileCheck %s
